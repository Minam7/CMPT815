...
<p>
As we can see in the recent correlation plot, I recognized there might be a correlation between gender and course name. Consequently, this correlation will be further explored in the following part.
</p>
```{r, message=FALSE, warning=FALSE, comment=NA}
