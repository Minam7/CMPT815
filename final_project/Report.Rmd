...
***
<p>
Nowadays, Massive Open Online Course systems have gained lots of attentions and is used in different levels of education.
In this project I will use [OULAD](https://analyse.kmi.open.ac.uk/open_dataset) which is the anonymised Open University Learning Analytics Dataset (OULAD). It contains data about courses, students and their interactions with Virtual Learning Environment (VLE) for seven selected courses (called modules).
</p>

<p>
In this project I mainly focus on following insights.
...
<p>
As we can see in this chart, more than average popular courses have more students in September terms. However, less popular courses doesn't follow such pattern.
</p>
***
...
```
<p>
As we can see in this chart, students with more resources have higher scores than other with low usage of resources. In order to statistically examine this claim, t-test will be applied.
</p>
...
```
<p>
As we see in this chart, the average score of courses, mostly relies on usage of online resources, rather than number of these resources. So we statistically examine this claim.
</p>
...
<p>
As we can see in these charts, at the beginning of the term, which students are motivated for the course, usage of online resources experience a peak. However, as we proceed to the end of the term, the usage of these resources decrease due to lost of interest until we reach the end of the term. Final exams result in the highest usage of resources for each course in each term.
</p>
...
<p>
As we can see in this chart, we have more female students than male students with low usage of system resources, however, this difference decreases as the usage of students increases.
</p>
...
<p>
As we can see in this chart, majority of the students are less than 35 years old, and higher percentage of them have more resource usage than other age groups.
</p>
