...
p <- ggplot(data = data, mapping = aes(x = logrank, y=logcount, color = refcount)) +  geom_point() + ggtitle("Page reference distribution") + ylab("log reference count") + xlab("log rank") + scale_color_gradient(low="darkgreen", high="lightgreen") + geom_line() + theme(legend.position = "none")
p
```
...
cat("mean interarrival times for sep 27 trace is: ", fullmean, " seconds and variance is: ", fullsc, " seconds")
cat("mean interarrival times for sep 27 12 - 16 trace is: ", halfmean, " seconds variance is: ", halfsc, " seconds")
```
...
p <- ggplot(data = plot_half_data, mapping = aes(x = diff, y = ccdf)) +  
  xlim(0,251) + ylim(NA, 1) + scale_y_continuous(trans = 'log10') + ggtitle("Interarrival times for 27 Sep 12-16") + xlab("Interarrival time") + ylab("CCDF") +
  geom_point() +
...
p <- ggplot(data = plot_full_data, mapping = aes(x = diff, y = ccdf)) +  
  xlim(0,251) + ylim(NA, 1) + scale_y_continuous(trans = 'log10') + ggtitle("Interarrival times for 27 Sep") + xlab("Interarrival time") + ylab("CCDF") +
  geom_point() +
