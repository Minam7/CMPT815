...
p <- ggplot(data = data, mapping = aes(x = logrank, y=logcount, color = refcount)) +  geom_point() + ggtitle("Page reference distribution") + ylab("reference count") + scale_color_gradient(low="darkgreen", high="lightgreen") + geom_line() + theme(legend.position = "none")
p
```
