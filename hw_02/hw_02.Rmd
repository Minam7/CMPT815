...
$$R = \frac{S}{1 - \lambda*S} = \frac{S}{1 - U} = \frac{0.1millisecond*\frac{1second}{1000millisecond}}{1-0.8} = 0.0005=0.05millisecond$$
...
$$R = S+\frac{S}{2}(\frac{\lambda S}{1-\lambda S}) = 0.0001 + 0.00005(\frac{0.8}{0.2})=0.0003$$
